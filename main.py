...
CONNECTION_STRING = "DefaultEndpointsProtocol=https;AccountName=devlab402;AccountKey=FdLlnZJ+6KaJB6VGtplA7WSe8xzLZO3L3USNZE3aqiooSoQVPXnD4OVMa1OlOKzj0bafv4aOPWLW+AStqUF32A==;EndpointSuffix=core.windows.net"
CONTAINER_NAME = "fotos"
ACCOUNT_NAME = "devlab402"

# Configurações do Azure SQL Server
SQL_SERVER   = "dbsrvdeveastuslab402.database.windows.net"
SQL_DATABASE = "sqllab001dbdeveastus"
SQL_USERNAME = "gfrancaribeiro402"
...
def insert_product_sql(product_data):
    try:
        conn = pymysql.connect(server=SQL_SERVER, user=SQL_USERNAME, password=SQL_PASSWORD, database=SQL_DATABASE)
        cursor = conn.cursor()
